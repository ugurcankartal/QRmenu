            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            "is_mobile",
                            models.BooleanField(default=False, verbose_name="Mobil"),
                        ),
                        (
                            "is_bot",
                            models.BooleanField(default=False, verbose_name="Bot"),
                        ),
                        (
                            "request_method",
                            models.CharField(
                        ...
                        (
                            ...
                            models.CharField(
                                blank=True,
                                max_length=512,
                                verbose_name="Istek yolu",
                            ),
                        ),
                        (
                            "query_string",
                            models.TextField(blank=True, verbose_name="Query string"),
                        ),
                        (
                            "request_body",
                            models.TextField(
                                blank=True,
                                verbose_name="Istek govdesi (kisaltilmis)",
                            ),
                        ),
                        (
                            "matched_pattern",
                        ...
                        (
                            ...
                            models.TextField(
                                blank=True,
                                verbose_name="Eslesen deger (kisaltilmis)",
                            ),
                        ),
                        (
                            "source",
                        ...
                        (
                            ...
                            models.JSONField(
                                blank=True,
                                default=dict,
                                verbose_name="Guvenlik basliklari",
                            ),
                        ),
                    ],
                    options={
                        ...
                        "indexes": [
                            models.Index(
                                fields=["-created_at"],
                                name="api_sqlinje_created_8e7f86_idx",
                            ),
                            models.Index(
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            ...
                            models.CharField(
                                choices=[
                                    ("success", "Basarili giris"),
                                    ("failed", "Basarisiz giris"),
                                    ("blocked", "Kilitli (cok deneme)"),
                                    ("forbidden_role", "Yetkisiz rol"),
                                    ("validation_error", "Eksik alan"),
                                ],
                                max_length=32,
                                verbose_name="Olay",
                            ),
                        ...
                        (
                            "referer",
                            models.TextField(blank=True, verbose_name="Referer"),
                        ),
                        (
                            "host",
                            models.CharField(
                        ...
                        (
                            "is_secure",
                            models.BooleanField(default=False, verbose_name="HTTPS"),
                        ),
                        (
                            "is_mobile",
                            models.BooleanField(default=False, verbose_name="Mobil"),
                    ...
                    options={
                        ...
                        "indexes": [
                            models.Index(
                                fields=["-created_at"],
                                name="api_fronten_created_773e59_idx",
                            ),
                            models.Index(
                                fields=["ip_address", "-created_at"],
