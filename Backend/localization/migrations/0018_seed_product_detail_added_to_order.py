...
UI_STRINGS = {
    "product-detaile.added-to-order": {
        "help_text": "Ürün detay modalında adisyona eklendi butonu metni.",
        "translations": {
            "tr": "Adisyona Eklendi",
            "en": "Added to order",
        },
...
def seed_product_detail_added_to_order(apps, schema_editor):
...
def unseed_product_detail_added_to_order(apps, schema_editor):
    UiStringKey = apps.get_model("localization", "UiStringKey")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("localization", "0017_seed_product_detail_add_to_order"),
    ]

    operations = [
        migrations.RunPython(
            seed_product_detail_added_to_order,
            unseed_product_detail_added_to_order,
        ),
    ]
